...
trades = Table(
    ...
    Column("trade_type", String, nullable=True),
    Column("strategy_id", Integer, nullable=True),
    Column("confidence", Integer, nullable=True),
    Column("target", Float, nullable=True),
    ...
    Column("buy_timestamp", DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP")),
    Column("sell_timestamp", DateTime, nullable=True, server_default=text("CURRENT_TIMESTAMP")),
